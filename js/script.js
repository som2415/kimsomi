...
$(window).scroll(function(){
	...
	setInterval(function(){
	$("section>img:nth-child(7)").animate({top:0})
	$("section>img:nth-child(7)").animate({top:"-25px"})
	},500);
	setInterval(function(){
	...
	$("section>a:nth-child(8),#section7 p:nth-child(3)").mouseenter(function(){
		$(this).stop().animate({backgroundColor:"#fff", color:"#6e6eff",letterSpacing:"6px",fontWeight:"bold"})
	});
	$("section>a:nth-child(8),#section7 p:nth-child(3)").mouseleave(function(){
...
setInterval(function(){
    $(".mac_box>img").animate({top:"-600px"},2000);
     $(".mac_box>img").animate({top:"0"},2000);
});

setInterval(function(){
    $(".mac_box2>img").animate({top:"-720px"},2000);
     $(".mac_box2>img").animate({top:"0"},2000);
});

setInterval(function(){
    $(".mac_box3>img").animate({top:"-900px"},2000);
     $(".mac_box3>img").animate({top:"0"},2000);
});

setInterval(function(){
    $(".mac_box4>img").animate({top:"-730px"},2000);
     $(".mac_box4>img").animate({top:"0"},2000);
});
